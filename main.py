...
def pokazSchemat():
    schem = Toplevel(okno)
    lab = Label(schem, text="tu będzie pokaz danych")
    lab.pack()
...
teksty = [
    "Zastosowanie", "Cechy produktu", "Zdjęcie", "Rys. techniczny",
    "Krzywa rozsyłu", "Nagłówek", "Produkt", "Rodzina", "Parametry"
]
...
o_Entry_tolerancja2.insert(
    0, "** tolerancja strumienia świetlnego 7% w temp. otoczenia 25°C")
...
l_L20 = Label(okno, text="Kolor")
l_L20.place(x=450, y=270)
